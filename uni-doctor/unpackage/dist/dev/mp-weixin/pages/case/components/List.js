...
/* harmony import */ var _List_vue_vue_type_template_id_5329e19e_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./List.vue?vue&type=template&id=5329e19e&scoped=true& */ 344);
...
/* harmony import */ var _List_vue_vue_type_style_index_0_id_5329e19e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./List.vue?vue&type=style&index=0&id=5329e19e&lang=scss&scoped=true& */ 348);
...
var _default = { data: function data() {return { disabled: false, //是否禁用底部加载
    ...
    handleRefresh: function handleRefresh() {var _this2 = this; //下拉刷新
      var self = this;
      self.disabled = false;
      self.current = 1;
    ...
    handleSearchData: function handleSearchData(condition, hospital) {var _this3 = this; //查询数据
      ...
      this.$nextTick(function () {
        _this3.postCaseData(true); //请求病历库数据
      });
    } },
