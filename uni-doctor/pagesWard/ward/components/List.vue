			...
			<view class="list-item" v-for="(item, index) in wardList" :key="index">
				<view class="item-head">
					...
					<view class="head_state">
						<LayzImage v-if="item.state == 1" src="@pagesWard/ward/lab_ward_chafang.png" />
						<LayzImage v-if="item.state == 3 && item.joinNum > 0" src="@pagesWard/ward/lab_ward_paidui.png" />
					</view>
					<view class="head_vip" v-if="type == 'pri'">
						<LayzImage src="@pagesWard/ward/lab_ward_vip.png" />
					</view>
				</view>
